...
public class CrossAnimationButton extends View {
    ...
    private AnimatorSet mExpandAnimation = new AnimatorSet().setDuration(800);
    private AnimatorSet mCollapseAnimation = new AnimatorSet().setDuration(800);
    ...
    private void updateBackground() {
        Shape shape = new Shape() {
            ...
            public void draw(Canvas canvas, Paint paint) {
                canvas.drawRect(mCrossMargin, getMeasuredHeight() / 2 - mCrossWidth / 2, getMeasuredWidth() - mCrossMargin,
                        getMeasuredHeight() / 2 + mCrossWidth / 2, paint);
                canvas.drawRect(getMeasuredWidth() / 2 - mCrossWidth / 2, mCrossMargin, getMeasuredWidth() / 2 + mCrossWidth / 2,
                        getMeasuredHeight() - mCrossMargin, paint);
            }
        };
